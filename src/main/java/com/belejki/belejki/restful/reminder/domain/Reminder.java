package com.belejki.belejki.restful.reminder.domain;
...
public class Reminder {
    ...
    public boolean equals(Object o) {
        ...
        return importanceLevel == reminder.importanceLevel && Objects.equals(id, reminder.id) && Objects.equals(name, reminder.name) && Objects.equals(description, reminder.description) && Objects.equals(expiration, reminder.expiration);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, importanceLevel, description, expiration);
    }
}
